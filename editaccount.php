...
if(isset($_POST['aid']) && isset($_POST['id']) && isset($_POST['submit'])){
	...
	$miles = $_POST['miles'];
	$query = "update mileageaccount set firstname='$firstname', lastname='$lastname', accountname='$accountname', miles='$miles' where aid='$aid'";
	$mysqli->query($query);
...
<html>
<head>
<title>Edit Reward Account</title>
<meta charset="utf-8">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title"><center><b>Edit Account</b></center></h3>
			 			</div>
			 			<div class="panel-body">
			    		<form name="signupform" action="editaccount.php" method="post" onsubmit="return validatesignupform()">
			    			<div class="row">
<?php
if(isset($_POST['aid']) && isset($_POST['id'])){
$aid = $_POST['aid'];
$id = $_POST['id'];
...
?>
			    			...
			    			<input type="submit" name='submit' value="Edit Account" class="btn btn-info btn-block">
